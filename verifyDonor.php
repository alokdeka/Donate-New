...
elseif (is_numeric(htmlspecialchars($_GET['id']))) {
	...
	$id = $_GET['id'];
	$query = "SELECT * FROM `tbl_donors` WHERE `id`='$id' AND `is_verified`='0'";
	...
	<div id="page-wrapper">
		...
		<section id="main" class="container medium">
			<header>
				...
				<p>Your OTP: <?php echo $_SESSION["otp"];?></p>
			</header>
			<div class="box">
				<form  name="myForm" id="verificationEnter" action="_actions/verifyDonor.php" onsubmit="return validateForm()" method="POST">
